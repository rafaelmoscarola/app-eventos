    ...
    return (
      <div style={{
        ...
        <div style={{ position:"relative", zIndex:10, textAlign:"center", padding:"20px", maxWidth:"420px", width:"100%" }}>
          ...
          <div style={{ background:"linear-gradient(145deg, rgba(255,255,255,0.08) 0%, rgba(255,182,210,0.06) 100%)", borderRadius:"32px", padding:"36px 28px 32px", border:"1.5px solid rgba(255,182,210,0.3)", backdropFilter:"blur(20px)", animation:"pulseGlow 3s ease-in-out infinite", marginTop:"8px" }}>
            ...
            <div style={{ fontFamily:"Brittany Signature, cursive", fontSize:"clamp(3rem, 14vw, 4.8rem)", color:"#fff4b8", lineHeight:1.1, marginBottom:"18px", textShadow:"0 0 28px rgba(255,244,184,0.6), 0 0 60px rgba(255,244,184,0.25)", animation:"slideUp 0.6s ease 0.5s both" }}>
              {propuesta?.cliente}
            </div>
            <div style={{ color:"rgba(255,255,255,0.55)", fontSize:"0.9rem", marginBottom:"6px", animation:"slideUp 0.6s ease 0.65s both" }}>
              tiene un regalo de
            </div>
            <div style={{ fontFamily:"Inter, Arial, sans-serif", fontSize:"1.45rem", fontWeight:700, color:"#ffb6d2", marginBottom:"32px", letterSpacing:"0.5px", textShadow:"0 0 20px rgba(255,182,210,0.5)", animation:"slideUp 0.6s ease 0.8s both" }}>
              {modoRegalo} 💝
            </div>
            <button
              type="button"
  ...
  if (esRegalo && faseRegalo === "abriendo") {
    return (
      <div style={{ minHeight:"100vh", background:"linear-gradient(145deg, #0d1b3e 0%, #1a0a2e 40%, #0a1628 100%)", display:"flex", alignItems:"center", justifyContent:"center" }}>
        <style>{`
          @keyframes lazoSplit { 0%{transform:scaleX(1) scaleY(1);opacity:1} 40%{transform:scaleX(1.3) scaleY(0.6);opacity:1} 70%{transform:scaleX(2.5) scaleY(0.1);opacity:0.6} 100%{transform:scaleX(4) scaleY(0);opacity:0} }
          @keyframes brilloFinal { 0%{opacity:0;transform:scale(0.5)} 50%{opacity:1;transform:scale(1.3)} 100%{opacity:0;transform:scale(2.5)} }
        `}</style>
